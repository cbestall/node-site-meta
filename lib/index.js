...
var SiteMeta = function(  ){
    ...
    var $ = cheerio.load( response.body );
    	...
    	return $( this ).attr( "rel" ) ? $( this ).attr( "rel" ).toLowerCase() == 'apple-touch-icon' : "";
		...
		/* Canonical */
		meta.canonical = $( "meta" ).filter(function() {
    	return $( this ).attr( "name" ) ? $( this ).attr( "name" ).toLowerCase() == 'canonical' : "";
    }).attr( "href" ) || "";
