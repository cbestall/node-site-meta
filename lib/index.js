...
var SiteMeta = function(  ){
    ...
    meta.feeds = $( "link" ).filter(function() {
		...
		/* Open Graph */    
		meta.og = parseGraphContent( "og", ["title", "type", "image", "url", "description", "site_name"] );
...
// :image2
		...
		/* Twitter */
    meta.twitter = parseGraphContent( "twitter", ["card", "site", "title", "url", "description", "image"] );


		function parseGraphContent( graphtype, itemArray ) {
